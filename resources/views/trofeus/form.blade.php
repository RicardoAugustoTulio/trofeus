  ...
  <div class="card-body">
    <form id="form" method="post" action="{{route($route)}}" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-6">
                ...
                @if(isset($trofeu) && !empty($trofeu->url_imagem))
                    <div class="d-flex align-items-center">
                        ...
                        <button type="button"
                                onclick="deletarDados('{{route('trofeus-deletar-imagem')}}','form','delete')"
            ...
            <div class="col-sm-6">
                <label class="col-form-label" for="competicao">
                    Competição
                </label>
                <div class="input-group input-group-merge">
                    <span class="input-group-text"><i class='bx bxs-info-circle'></i></span>
                    <input type="text" class="form-control" id="competicao"
                           name="competicao"
                           value="{{ isset($trofeu->competicao) ? $trofeu->competicao : old('competicao') }}"/>
                </div>
                {!!  $errors->has('competicao') ? "<span class='invalid text-danger'>". $errors->first('competicao') ."</span>" : '' !!}
            </div>
            <div class="col-sm-12">

  ...
  <div class="card mb-4 border-top border-primary">
    <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-xl-4 col-md-6 col-sm-12 mb-4">
            ...
            <div class="input-group">
              <input type="text" id="sigla" name="sigla" class="form-control" value="{{request()->sigla}}">
            </div>
          </div>
      ...
      <div class="col-12 d-flex justify-content-end">
        <a class="btn btn-primary ml-auto mt-2 text-white" href="{{route('campus-novo')}}">Adicionar
          Campus</a>
      </div>
    </div>
  </div>
